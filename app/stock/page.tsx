          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                download
                className="flex items-center gap-1.5 text-xs text-gray-300 hover:text-green-400 transition-colors bg-white/5 px-3 py-1.5 rounded-lg border border-white/10"
              >
                  ...
                  <table className="data-table">
                    <thead>
                      <tr>
                        ...
                        <th className="text-center">{["TRIMS","VOLOS TRIMS","OTHER TRIMS"].includes(cat) ? "Total Pcs" : "Pieces"}</th>
                      ...
                      {(cat === "SPC FLOORING" ? items.slice().sort((a, b) => a.sqftPerPlank - b.sqftPerPlank) : items).map((p) => {
                        ...
                        return (
                          <tr key={p.id}>
                            ...
                            <td className="text-center tabular-nums text-gray-500">{p.loosePieces || "—"}</td>
                            <td className="text-center tabular-nums font-medium text-gray-900">
